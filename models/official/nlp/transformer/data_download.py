...
SRC_VOCAB_FILE = "vocab.en.%d" % _TARGET_VOCAB_SIZE
TGT_VOCAB_FILE = "vocab.de.%d" % _TARGET_VOCAB_SIZE
...
def main(unused_argv):
  ...
  train_tfrecord_files = encode_and_save_files(src_subtokenizer, tgt_subtokenizer, FLAGS.data_dir,
                                               compiled_train_files, _TRAIN_TAG,
                                               _TRAIN_SHARDS)
  encode_and_save_files(src_subtokenizer, tgt_subtokenizer, FLAGS.data_dir, compiled_eval_files,
